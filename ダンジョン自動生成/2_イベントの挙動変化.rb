...
#   イベントの移動頻度が「最高」で プレイヤーと同時移動、
#  「高」でプレイヤー２歩でイベントが１歩移動となります。
#
#   アイテムのメモ欄に <random> といれると自動生成ダンジョン内でのみ
#   使えるアイテムを作れます。
#
#   いろいろつくりかけです。
#==============================================================================
...
class Scene_Map
  ...
  def update
    saba_dungeon_update
    if Input.trigger?(:C) && ! $game_map.interpreter.running?
